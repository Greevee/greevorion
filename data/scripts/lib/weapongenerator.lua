...
function WeaponGenerator.generateBeamlaser(rand, dps, tech, material, rarity)
    ...
    local type =                       rand:getInt(1,3)
    if type == 1 then
        weapon.name =                  "Ultraviolet Beamlaser /* Weapon Name*/"%_t
        weapon.prefix =                "Ultraviolet Beamlaser /* Weapon Prefix*/"%_t
        dmgMod =                       1.2
        reachMod =                     0.8
    elseif type == 2 then
        weapon.name =                  "Standard Beamlaser /* Weapon Name*/"%_t
        weapon.prefix =                "Standard Beamlaser /* Weapon Prefix*/"%_t
        dmgMod =                       1
        reachMod =                     1
    else
        weapon.name =                  "Infrared Beamlaser /* Weapon Name*/"%_t
        weapon.prefix =                "Infrared Beamlaser /* Weapon Prefix*/"%_t
        dmgMod =                       0.8
        reachMod =                     1.2
    end
    local fireDelay =                  0.1
...
function WeaponGenerator.generatePulselaser(rand, dps, tech, material, rarity)
    ...
    local type =                       rand:getInt(1,3)
    if type == 1 then
        weapon.name =                  "Ultraviolet Pulselaser /* Weapon Name*/"%_t
        weapon.prefix =                "Ultraviolet Pulselaser /* Weapon Prefix*/"%_t
        dmgMod =                       1.2
        reachMod =                     0.8
    elseif type == 2 then
        weapon.name =                  "Standard Pulselaser /* Weapon Name*/"%_t
        weapon.prefix =                "Standard Pulselaser /* Weapon Prefix*/"%_t
        dmgMod =                       1
        reachMod =                     1
    else
        weapon.name =                  "Infrared Pulselaser /* Weapon Name*/"%_t
        weapon.prefix =                "Infrared Pulselaser /* Weapon Prefix*/"%_t
        dmgMod =                       0.8
        reachMod =                     1.2
    end
